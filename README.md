...
Regarding the data, only the file from the KNMI is shared, but can also be downloaded on https://daggegevens.knmi.nl/klimatologie/daggegevens. Other data is not shared due to legal issues. However, previews can be seen on GitHub since these do not contain any personal data.
